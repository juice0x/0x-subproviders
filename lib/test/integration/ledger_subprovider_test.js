...
describe('LedgerSubprovider', () => {
    ...
    describe('direct method calls', () => {
        ...
        it('signs a personal message', () => __awaiter(void 0, void 0, void 0, function* () {
            const data = ethUtils.bufferToHex(ethUtils.toBuffer(fixture_data_1.fixtureData.PERSONAL_MESSAGE_STRING));
            const ecSignatureHex = yield ledgerSubprovider.signPersonalMessageAsync(data, fixture_data_1.fixtureData.TEST_RPC_ACCOUNT_0);
        ...
        it('signs a personal message with second address', () => __awaiter(void 0, void 0, void 0, function* () {
            const data = ethUtils.bufferToHex(ethUtils.toBuffer(fixture_data_1.fixtureData.PERSONAL_MESSAGE_STRING));
            const ecSignatureHex = yield ledgerSubprovider.signPersonalMessageAsync(data, fixture_data_1.fixtureData.TEST_RPC_ACCOUNT_1);
